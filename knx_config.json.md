...
```
`knxconnection` if set to "knxjs" then (knx multicast)[https://www.npmjs.com/package/knx] routing is used, set to any other value or non-existent will default to knxd  
