 ...
 * This is the version for dynamic installation 
 * 
 * 
 */
...
//			this.addOptionalCharacteristic(Characteristic.HeatingThresholdTemperature);
			...
			if (config.TargetTemperature) {
				...
				// myService.getCharacteristic(Characteristic.TargetTemperature).setValue(21, undefined, 'fromKNXBus'); // °C simulate a received value
