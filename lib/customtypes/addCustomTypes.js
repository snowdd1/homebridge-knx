...
module.exports = function(API) {
	...
	var myCharacteristic, myService;
        ...
        for (charName in myKNX.Characteristic) {
		log("### Processing KNX Characteristics '" + charName + "' with UUID '" + myKNX.Characteristic[charName].UUID +"'");
		var myKNXName = "KNX" + charName;
		myCharacteristic = myKNX.Characteristic[charName];
        ...
        for (serviceName in myKNX.Service) {
		log("### Processing KNX Services '" + serviceName + "' with UUID '" + myKNX.Service[serviceName].UUID + "'");
		var myKNXName = "KNX" + serviceName;

		myService = myKNX.Service[serviceName];
