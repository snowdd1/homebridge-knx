...
var url = 'https://github.com/snowdd1/homebridge-knx/blob/master/custom/characteristics.json';
...
request({
    ...
    if (!error && response.statusCode === 200) {
        console.log('Custom types file found'); // Print the json response
        /* 
         * In here the online updater off all characteristics found online should happen
         */
