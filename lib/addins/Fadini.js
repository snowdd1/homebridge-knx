/* 
 * HOMEKIT-KNX Addin Module for Fadini Combi 740 Gate Opener
 *
 ...
 * When button released (actuator = OFF) 'closing ritual' starts with a (30 seconds) timer.
 ...
 * - ExtendedOpen - extra open time before starting closing ritual - defaults to 0 seconds
 *
 ...
 * ExtendedOpen should then be set to the *extra* time required and only works when AutoClose is true.
 *
...
class Fadini extends HandlerPattern 
{
	onServiceInit() 
    {
		...
		log(`INFO: fadini module initialized with traveltime=${this.TravelTime} OpenTime=${this.OpenTime} AutoClose=${this.AutoClose} ExtendedOpen=${this.ExtendedOpen}`);
    }
