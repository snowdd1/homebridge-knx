...
/**
 * Maps a homeKit characteristic to an Array of Group Addresses without value mappings Attention please: If you map
 * multiple GA on a writing (Set) characteristic, all of them will be written to! Used for all On/Off types, all
